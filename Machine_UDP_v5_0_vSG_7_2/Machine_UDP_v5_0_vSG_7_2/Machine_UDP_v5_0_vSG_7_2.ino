...
//  bribric  modification  to send  GPS  speed  only  if applied  is necessary 
//   if  section 1  is on   gps speed is transfert  to pin9
//   if  section 1 or section 2  is on   gps speed is transfert  to pin9
//   if  section 1 or section 2 or section 3 is on   gps speed is transfert  to pin9
...
#define PULSE_ERROR -0.13
 ...
 //   tone(vit,gpsSpeed);
    ...
    digitalWrite (tram2, bitRead(tramline,2)); //D12, D13
 }
